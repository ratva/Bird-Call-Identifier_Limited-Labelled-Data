...
parser.add_argument('--last_layer_ft', type=ast.literal_eval, default=False, help="perform last-layer fine-tuning")
# parser.add_argument("--num-workers", default=0, type=int, help="# of workers for dataloading (default: 32)")
